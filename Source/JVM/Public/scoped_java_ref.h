...
#ifndef UE_JVM_SCOPED_JAVA_REF_H
#define UE_JVM_SCOPED_JAVA_REF_H
...
namespace UJNI {
	...
	class JVM_API ScopedJavaLocalFrame {
	public:
	...
	public:
		...
		// constructor below.
		ScopedJavaLocalRef(ScopedJavaLocalRef&& other) noexcept : env_(other.env_) {
	...
	public:
		...
		// Move constructor. This is required in addition to the move conversion
		// constructor below.
		ScopedJavaGlobalRef(ScopedJavaGlobalRef&& other) noexcept {
			JavaRef<T>::steal(std::move(other));
		}
	...
	public:
		...
		JavaObjectArrayReader& operator=(const JavaObjectArrayReader& other) = default;
...
#endif  // UE_JVM_SCOPED_JAVA_REF_H
